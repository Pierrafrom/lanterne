...
Every :class:`~lanterne.core.models.Sighting` this scraper produces
...
:class:`~lanterne.io.scrapers.base.RatingRecord` objects, keyed by
IMDb id. See
...
from lanterne.core.models import ExtractedEvent, Sighting, Source
...
from lanterne.io.scrapers.paris_cine_info_parsing import (
    parse_film_ratings,
    parse_venue_detail,
    parse_venue_passes,
)
...
class ParisCineInfoScraper:
    ...
    async def fetch_venue_passes(
        ...
        Implements :class:`~lanterne.io.scrapers.base.VenuePassSource`.
    ...
    async def fetch_film_ratings(
        ...
        Implements :class:`~lanterne.io.scrapers.base.FilmRatingSource`.
    ...
    async def fetch_venue_details(
        ...
        Implements :class:`~lanterne.io.scrapers.base.VenueDetailSource`.
    ...
    async def _fetch_theatre_detail(
        ...
        *,
        ...
        if not isinstance(theater, dict):
            return None
        return parse_venue_detail(theater, include_room=include_room)
...
def build_showtime_item(
    ...
    :class:`~lanterne.io.llm.EventExtractor` can classify, and becomes a
