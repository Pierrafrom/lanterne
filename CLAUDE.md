...
festivals, cult screenings, ciné-clubs, short-film programmes) from eight
scraped sources (Première Projo, La Cinémathèque française, Le Forum des
images, Le Champo, Le Louxor, la Fondation Jérôme Seydoux-Pathé, La Villette,
Paris Ciné Info — the last an optional, authenticated source, see
