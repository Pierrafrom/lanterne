...
festivals, cult screenings, ciné-clubs, short-film programmes) from seven
scraped sources (Première Projo, La Cinémathèque française, Le Forum des
images, Le Champo, Le Louxor, la Fondation Jérôme Seydoux-Pathé, Paris Ciné
Info — the last an optional, authenticated source, see
